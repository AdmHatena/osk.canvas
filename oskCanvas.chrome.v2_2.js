  ...
  constructor(
    ...
    if(this.#canvasFront){
      ...
      rootDOM.addEventListener('keydown', (event)=>{
        this.#keyInput.keyCode[event.keyCode] = true;
        this.#keyInput.key[event.key] = true;
        this.#keyInput.alt = event.altKey;
        this.#keyInput.shift = event.shiftKey;
        this.#keyInput.ctrl = event.ctrlKey;
        this.#keyInput.meta = event.metaKey;
      });
      rootDOM.addEventListener('keyup', (event)=>{
        this.#keyInput.keyCode[event.keyCode] = false;
        this.#keyInput.key[event.key] = false;
        this.#keyInput.alt = event.altKey;
        this.#keyInput.shift = event.shiftKey;
        this.#keyInput.ctrl = event.ctrlKey;
        this.#keyInput.meta = event.metaKey;
